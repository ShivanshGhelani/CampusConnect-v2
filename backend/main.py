...
try:
    ...
    # certificates_router is already included via api_router -> app/v1/__init__.py
    app.include_router(api_router)      # API routes (includes admin, auth, email, organizer, certificates)
