                        ...
                        {user?.role && ['super_admin', 'executive_admin'].includes(user.role) && (
                            <div className="mb-1">
                                <div className="mx-2 space-y-1">
                                    <Link
                                        to="/admin/editor"
                                        className={`group flex items-center gap-3 px-3 py-2.5 text-slate-700 hover:text-pink-700 hover:bg-pink-50/80 rounded-xl transition-all duration-200 hover:scale-[1.02] ${isActive('/admin/editor') ? 'bg-gradient-to-r from-pink-500 to-rose-600 text-white hover:text-white shadow-lg shadow-pink-500/25' : ''
                                            }`}
                                        onClick={closeMobileMenu}
                                    >
                                        <div className="w-5 h-5 flex items-center justify-center">
