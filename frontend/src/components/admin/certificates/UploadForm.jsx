    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="existing-category" className="ml-2 text-sm text-gray-700">
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300"
              />
              <label htmlFor="new-category" className="ml-2 text-sm text-gray-700">
                Create new category
              </label>
            </div>
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-purple-600 to-violet-600 text-white font-bold py-3 px-6 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
        >
          {isUploading ? (
