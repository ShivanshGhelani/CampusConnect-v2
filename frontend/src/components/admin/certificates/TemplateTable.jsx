...
const TemplateTable = ({ 
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-100">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center space-x-1">
                    ...
                    <button
                      ...
                      className="text-purple-600 hover:text-purple-800 text-xs font-medium px-2 py-1 rounded hover:bg-purple-50 flex items-center gap-1"
                    ...
                    <button
                      ...
                      className="text-green-600 hover:text-green-800 text-xs font-medium px-2 py-1 rounded hover:bg-green-50 flex items-center gap-1"
                      title="Edit template"
                    >
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm bg-opacity-50 flex items-center justify-center z-9999">
