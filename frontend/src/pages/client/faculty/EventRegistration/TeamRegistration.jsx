...
const FacultyTeamRegistration = () => {
  ...
  const fetchEventData = async () => {
    try {
      ...
      if (eventResponse.data.success) {
        ...
        // Verify this is a faculty event and supports teams
      ...
      // Pre-populate team leader data with current faculty
      if (user) {
        setTeamData(prev => ({
          ...prev,
  ...
  const validateForm = () => {
    ...
    for (let i = 0; i < teamMembers.length; i++) {
      ...
      if (!member.faculty_name || !member.faculty_email || !member.department) {
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white p-6">
              <h1 className="text-2xl font-bold mb-2">Faculty Team Registration</h1>
              {event && (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleTeamDataChange}
                      rows="3"
                      placeholder="Brief description of your team and objectives..."
                      className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-green-500"
                    />
                  </div>
                      ...
                      <div key={member.id} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                          <div>
                            ...
                            <input
                              type="text"
                              value={member.faculty_name}
                              onChange={(e) => handleMemberChange(index, 'faculty_name', e.target.value)}
                              required
                          ...
                          <div>
                            ...
                            <input
                              type="email"
                              value={member.faculty_email}
                              onChange={(e) => handleMemberChange(index, 'faculty_email', e.target.value)}
                              required
                              disabled={member.isLeader}
                              className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-green-500 disabled:bg-gray-100"
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              disabled={member.isLeader}
                              placeholder="e.g., Technical Lead, Coordinator"
                              className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-green-500 disabled:bg-gray-100"
                            />
                          </div>
                        </div>
...
export default FacultyTeamRegistration;
