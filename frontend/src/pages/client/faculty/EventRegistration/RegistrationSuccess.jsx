...
const FacultyRegistrationSuccess = () => {
  ...
  const getRegistrationId = () => {
    ...
    return `REG-${eventId}-${user?.employee_id || user?.faculty_id || user?.id || 'TEMP'}-${Date.now().toString().slice(-6)}`;
  };
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-gray-900">{user?.full_name || user?.name || user?.faculty_name}</span>
                  </div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-700">Employee ID:</span>
                    <span className="text-sm text-gray-900">{user?.employee_id || user?.faculty_id}</span>
                  </div>
                  <div className="flex items-center justify-between mb-2">
              ...
              <div className="space-y-3">
                ...
                {event?.has_attendance && (
                  <Link
                    to={`/faculty/events/${eventId}/attendance`}
