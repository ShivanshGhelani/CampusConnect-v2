...
function EventDetail() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="container mx-auto max-w-5xl px-2 sm:px-4 py-4 sm:py-4 mt-6 sm:mt-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-blue-100/50 overflow-hidden">
          {/* Timeline Header */}
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-3 sm:px-6 py-3 border-b border-blue-100">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
              <h2 className="text-base sm:text-lg font-bold text-gray-800 flex items-center">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                  <circle cx="12" cy="12" r="10" />
                  <polyline points="12,6 12,12 16,14" />
                </svg>
                Event Timeline
              </h2>
              <div className={`text-xs sm:text-sm font-semibold px-2 sm:px-3 py-1 rounded-full transition-all duration-300 ${getCurrentTimelineStatus('registration_start') === 'current' || getCurrentTimelineStatus('registration_end') === 'current'
          ...
          <div className="p-3 sm:p-6">
            <div className="relative">
              {/* Timeline Steps */}
              <div className="flex flex-col lg:flex-row items-center justify-between gap-3 sm:gap-4 lg:gap-2">

                {/* Registration Opens */}
                <div className={`flex flex-col items-center group transition-all duration-300 ${getCurrentTimelineStatus('registration_start') === 'completed'
                  ? 'scale-105'
                  : getCurrentTimelineStatus('registration_start') === 'current'
                    ? 'scale-110'
                    : 'scale-100'
                  }`}>
                  <div className={`relative w-12 h-12 rounded-full flex items-center justify-center shadow-md transition-all duration-300 ${getCurrentTimelineStatus('registration_start') === 'completed'
                ...
                <div className="hidden lg:flex flex-1 items-center justify-center px-2">
                  <div className={`h-0.5 w-full rounded-full transition-all duration-500 ${getCurrentTimelineStatus('registration_start') === 'completed'
                ...
                {/* Registration Closes */}
                <div className={`flex flex-col items-center group transition-all duration-300 ${getCurrentTimelineStatus('registration_end') === 'completed'
                  ? 'scale-105'
                  : getCurrentTimelineStatus('registration_end') === 'current'
                    ? 'scale-110'
                    : 'scale-100'
                  }`}>
                  <div className={`relative w-12 h-12 rounded-full flex items-center justify-center shadow-md transition-all duration-300 ${getCurrentTimelineStatus('registration_end') === 'completed'
                    ? 'bg-gradient-to-br from-green-400 to-emerald-500'
                    : getCurrentTimelineStatus('registration_end') === 'current'
                ...
                {/* Connecting Line 2 */}
                <div className="hidden lg:flex flex-1 items-center justify-center px-2">
                  <div className={`h-0.5 w-full rounded-full transition-all duration-500 ${getCurrentTimelineStatus('registration_end') === 'completed'
                ...
                {/* Event Starts */}
                <div className={`flex flex-col items-center group transition-all duration-300 ${getCurrentTimelineStatus('event_start') === 'completed'
                  ? 'scale-105'
                  : getCurrentTimelineStatus('event_start') === 'current'
                    ? 'scale-110'
                    : 'scale-100'
                  }`}>
                  <div className={`relative w-12 h-12 rounded-full flex items-center justify-center shadow-md transition-all duration-300 ${getCurrentTimelineStatus('event_start') === 'completed'
                    ? 'bg-gradient-to-br from-green-400 to-emerald-500'
                    : getCurrentTimelineStatus('event_start') === 'current'
                ...
                {/* Connecting Line 3 */}
                <div className="hidden lg:flex flex-1 items-center justify-center px-2">
                  <div className={`h-0.5 w-full rounded-full transition-all duration-500 ${getCurrentTimelineStatus('event_start') === 'completed'
                ...
                {/* Event Ends */}
                <div className={`flex flex-col items-center group transition-all duration-300 ${getCurrentTimelineStatus('event_end') === 'completed'
                  ? 'scale-105'
                  : getCurrentTimelineStatus('event_end') === 'current'
                    ? 'scale-110'
                    : 'scale-100'
                  }`}>
                  <div className={`relative w-12 h-12 rounded-full flex items-center justify-center shadow-md transition-all duration-300 ${getCurrentTimelineStatus('event_end') === 'completed'
                    ? 'bg-gradient-to-br from-green-400 to-emerald-500'
                    : getCurrentTimelineStatus('event_end') === 'current'
      ...
      {/* Event Poster Section - Edge to Edge */}
      {event.event_poster_url && (
        <div className="relative m-5 group max-w-5xl mx-auto xs:max-w-lg sm:max-w-2xl lg:max-w-3xl xl:max-w-5xl">
          <img
            src={event.event_poster_url}
            alt={`${event.event_name || event.name || 'Event'} Poster`}
            className="w-full h-auto object-cover transition-all duration-500 group-hover:brightness-105"
            onError={(e) => {
              e.target.style.display = 'none';
              e.target.parentElement.innerHTML = `
                  <div class="flex items-center justify-center h-96 bg-gradient-to-br from-gray-50 to-gray-100 border-t border-b border-gray-200">
                    <div class="text-center">
                      <svg class="w-16 h-16 text-gray-300 mx-auto mb-4" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clip-rule="evenodd" />
                      </svg>
                      <p class="text-gray-400 text-lg font-medium">Event Poster</p>
                      <p class="text-gray-300 text-sm mt-1">Image not available</p>
                    </div>
                  </div>
                `;
            }}
      ...
      <div className="container mx-auto max-w-5xl px-2 sm:px-4 py-4 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="flex flex-col space-y-4 sm:space-y-6 lg:space-y-8">
            {/* Event Organizers */}
            <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-purple-100 p-4 sm:p-6">
              <div className="flex items-center mb-3 sm:mb-4">
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-purple-500/20 rounded-full flex items-center justify-center mr-2 sm:mr-3">
                ...
                <h2 className="text-lg sm:text-xl font-bold text-gray-800">Event Organizers</h2>
              </div>
              <div className="space-y-4">
                ...
                {/* Organizing Team */}
                {(event.organizer_details || event.organizers || event.organizer_name || event.contacts) && (
                  <div className="space-y-3">
                    <div className="text-sm font-medium text-gray-800 mb-3">Organizing Team</div>

                    {/* Display from organizer_details array (primary source) */}
                    {event.organizer_details && Array.isArray(event.organizer_details) && event.organizer_details.length > 0 && event.organizer_details.map((organizer, index) => {
                      if (!organizer || !organizer.full_name) return null;

                      const organizerInitial = organizer.full_name.charAt(0).toUpperCase();
                        ...
                        <div key={index} className="p-4 bg-purple-50 rounded-lg border border-purple-100">
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                              <div className="font-medium text-gray-800 mb-1">{organizer.full_name}</div>
                              ...
                              {organizer.email && (
                                <div className="mt-2">
                                  <div className="flex items-center">
                                    ...
                                    <a href={`mailto:${organizer.email}`} className="text-sm text-blue-600 hover:text-blue-800 transition-colors">
                                      {organizer.email}
                                    </a>
                                  </div>
                                </div>
                    ...
                    {/* Display Additional Contacts (separate from organizers) */}
                    {event.contacts && Array.isArray(event.contacts) && event.contacts.length > 0 && (
                      <div className="mt-4">
                        <div className="text-sm font-medium text-gray-800 mb-3">Additional Contacts</div>
                        {event.contacts.map((contact, index) => {
                          if (!contact || !contact.name || !contact.contact) return null;

                          // Parse contact field which can contain email, phone, or both separated by comma
                          const contactParts = contact.contact.split(',').map(part => part.trim());
                              ...
                              <div className="flex items-start space-x-3">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="mt-2 space-y-1">
                                    {contactParts.map((contactInfo, partIndex) => {
                                      const isEmail = contactInfo.includes('@');
                                      const isPhone = contactInfo.startsWith('+') ||
                                        contactInfo.replace(/[-\s]/g, '').match(/^\d+$/);
                                        ...
                                        <div key={partIndex} className="flex items-center">
                                          {isEmail ? (
                                            <>
                                              ...
                                              <a href={`mailto:${contactInfo}`} className="text-sm text-blue-600 hover:text-blue-800 transition-colors">
                                                {contactInfo}
                                              </a>
                                            </>
                                          ) : isPhone ? (
                                            <>
                                              ...
                                              <a href={`tel:${contactInfo}`} className="text-sm text-blue-600 hover:text-blue-800 transition-colors">
                                                {contactInfo}
                                              </a>
                                            </>
                                          ) : (
                    ...
                    {/* Legacy fallback for old organizers array */}
                    {(!event.organizer_details || !Array.isArray(event.organizer_details) || event.organizer_details.length === 0) &&
                      (!event.contacts || !Array.isArray(event.contacts) || event.contacts.length === 0) &&
                    ...
                    {/* Legacy fallback for single organizer */}
                    {(!event.organizer_details || !Array.isArray(event.organizer_details) || event.organizer_details.length === 0) &&
                      (!event.contacts || !Array.isArray(event.contacts) || event.contacts.length === 0) &&
          ...
          {/* Right Column */}
          <div className="flex flex-col space-y-4 sm:space-y-6 lg:space-y-8">              {/* Registration Details */}
            <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-green-100 p-4 sm:p-6 w-full max-w-full">
              <div className="flex items-center mb-3 sm:mb-4">
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-green-500/20 rounded-full flex items-center justify-center mr-2 sm:mr-3">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 border-b border-gray-100 space-y-1 sm:space-y-0">
                  <span className="text-xs sm:text-sm font-medium text-gray-600">Mode</span>
                  <span className="text-xs sm:text-sm font-semibold text-gray-800">                      {event.mode ? (
                    event.mode === 'online' ? (
