        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Departments</h3>
                <p className="text-2xl font-bold text-gray-900 mt-1">{availableDepartments.length}</p>
              </div>
            </div>
          </div>
