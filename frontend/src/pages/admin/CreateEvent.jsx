...
function CreateEvent() {
  ...
  // State for clear form confirmation
  ...
  // Function to handle clearing the form with user confirmation
  const handleClearForm = () => {
    ...
    setForm({
      ...
      organizers: [{ name: '', email: '', employee_id: '', selected: false, isNew: false }],
    ...
    alert('Form cleared successfully! Starting fresh.');
  };
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <RichTextEditor
                  ...
                  onChange={(value) => setForm(prev => ({ ...prev, detailed_description: value }))}
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="inline-flex items-center px-3 py-2 border border-red-300 text-red-700 bg-white hover:bg-red-50 rounded-md text-sm font-medium transition-colors"
              ...
              <button
                type="button"
                onClick={() => window.open('/admin/certificate-canvas', '_blank')}
                ...
                title="Visual Certificate Designer - Drag & drop canvas"
              >
                <svg className="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
        ...
        <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex items-center justify-center z-[99999] animate-in fade-in duration-200 p-4">
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
            ...
            <p className="text-sm text-gray-700 mb-6">
              Are you sure you want to clear all saved form data? All your progress will be lost and you'll start with a fresh form.
            </p>
